...
def train():
    ...
    for i in trange(start, N_iters):
        ...
        elif 2000<=i and i<2500:
            img_loss = loss_imgmse + 1e-4 * loss_imguncert
        elif 4000<=i and i<4500:
            img_loss = loss_imgmse + 1e-3 * loss_imguncert
        elif 6000<=i and i<6500:
            img_loss = loss_imgmse + 1e-2 * loss_imguncert
        elif 8000<=i and i<8500:
            img_loss = loss_imgmse + 1e-1 * loss_imguncert
        elif 10000<=i and i<10500:
            img_loss = loss_imgmse + 1e-1 * loss_imguncert
        else:
            img_loss = loss_imgmse
        #############################################################################################################

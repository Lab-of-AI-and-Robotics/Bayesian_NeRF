...
class Renderer(object):
    def __init__(self, cfg, args, slam, points_batch_size=500000, ray_batch_size=100000, uncert=False, sigmoid=False
                 ):
    ...
    def eval_points(self, p, decoders, c=None, stage='color', device='cuda:0'):
        ...
        for pi in p_split:
            ...
            if self.uncert:
                if len(ret.shape) == 1 and ret.shape[0] == 5:
                    ret = ret.unsqueeze(0)
            else:
        ...
        # ret : (48000,4)
        # 원래 : r, g, b, occupancy
        # 수정후 : r, g, b, uncertainty, occupancy
        return ret
    ...
    def render_batch_ray(self, c, decoders, rays_d, rays_o, device, stage, gt_depth=None):
        ...
        if N_importance > 0:
            ...
            ########## 수정 전
                ...
                return depth, uncertainty_, color
